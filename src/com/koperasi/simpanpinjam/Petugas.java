...
public class Petugas extends JFrame {
	...
	*/
	...
	public Petugas() {
		...
		lblTglLahir.setBounds(30, 123, 90, 14);
		...
		lblFotoKtp.setBounds(30, 242, 90, 14);
		contentPane.add(lblFotoKtp);
		
		JLabel lblTempatLahir = new JLabel("Password");
		lblTempatLahir.setBounds(30, 57, 76, 14);
		...
		text_HpAnggota.setBounds(163, 211, 219, 20);
		contentPane.add(text_HpAnggota);
		text_HpAnggota.setColumns(10);
		
		JButton buttonBrowse = new JButton("Browse ...");
		buttonBrowse.setBounds(163, 238, 89, 23);
		...
		buttonSave.setBounds(164, 314, 89, 23);
		...
		buttonUpdate.setBounds(263, 314, 89, 23);
		...
		buttonDelete.setBounds(362, 314, 89, 23);
		...
		buttonClear.setBounds(461, 314, 89, 23);
